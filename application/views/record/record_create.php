                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href='/record'>Riwayat Pasien</a></li>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo site_url('record/create-post')?>" method="POST">
                                                ...
                                                <div class="form-group mb-2">
                                                    <label class="text-secondary fs-6" for="symptoms">Gejala</label>
                                                    <textarea name="symptoms" required class="form-control" placeholder="Isikan gejala" rows="3"></textarea>
                                                </div>
