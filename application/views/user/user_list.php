                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-end">
                                        <a href="<?php echo site_url('/user/create'); ?>" class="btn btn-success btn-sm"><i class="fas fa-fw fa-add"></i>User</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="table">
                                    ...
                                    <?php if (!empty($user)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('/user/edit?id='); ?><?php echo $item['ID']; ?>" class="btn btn-sm btn-light"><i class="fas fa-fw fa-pencil"></i>Edit</a>
            ...
            function deleteConfirm(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "<?php echo site_url('/user/delete?id='); ?>"+id
                    }
                });
            }
        </script>
